...
export class ForOf extends Instruccion {
    ...
    compile(env: Entorno): void {
        ...
        const valHeap = generator.newTemporal();
        const relativa = generator.newTemporal();
        generator.addExpression(relativa, iterador, 1, '+');
        generator.addGetHeap(valHeap, relativa);
