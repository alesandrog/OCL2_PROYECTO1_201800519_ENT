...
*/
var AstEjecucion = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o};
var parser = {trace: function trace () { },
yy: {},
symbols_: {"error":2,"Init":3,"instruccion":4,"EOF":5,"accesos":6,"acceso":7,".":8,"ID":9,"[":10,"Expr":11,"]":12,"llamadaFuncion":13,"(":14,"paramsExp":15,")":16,",":17,"Type":18,"TYPE":19,"=":20,"{":21,"decla_atr_type":22,"}":23,"atr_type":24,":":25,"tipo":26,"atributosType":27,"atribType":28,"ternario":29,"?":30,"$accept":0,"$end":1},
terminals_: {2:"error",4:"instruccion",5:"EOF",8:".",9:"ID",10:"[",11:"Expr",12:"]",14:"(",16:")",17:",",19:"TYPE",20:"=",21:"{",23:"}",25:":",26:"tipo",30:"?"},
productions_: [0,[3,2],[6,2],[6,1],[7,2],[7,3],[13,4],[13,3],[15,3],[15,1],[18,6],[22,3],[22,1],[24,3],[27,3],[27,1],[28,3],[29,5]],
...
/*    | 'FOR' '(' asignacion Expr ';' asignacion ')' BloqueInstrucciones
    { 
        this.$ = new For( $$[$01], $$[$02] , $$[$04], $$[$06] , _$[$0-1].first_line, _$[$0-1].first_column);
    }       
...
F   : '(' Expr ')'
    ...
    | 'ID'
    {
        let fID = new NodoGraphviz(`node_${nodoActual}` , `[label = \"${$$[$0-1]}\"];\n`, [] );
        listaNodos.push(fID);
        nodoActual++;        
        this.$ = fID;
...
break;
case 57:return 'FUNCTION'
break;
case 58:return 'LET'
break;
case 59:return 'CONST'
break;
case 60:return 'CONSOLE'
break;
case 61:return 'LOG'
break;
case 62:return 'GRAFICAR'
break;
case 63:return 'PUSH'
break;
case 64:return 'POP'
break;
case 65:return 'LENGTH'
break;
case 66:return 'VOID'
break;
case 67:return 'NUMBER'
break;
...
exports.parser = AstEjecucion;
exports.Parser = AstEjecucion.Parser;
exports.parse = function () { return AstEjecucion.parse.apply(AstEjecucion, arguments); };
