...
Pushear
    ...
    {
        let idPush = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;        
        let pushPush = new NodoGraphviz("node_"+nodoActual , '[label="push"];\n', [] );
        nodoActual++;
        let paraPush = new NodoGraphviz("node_"+nodoActual , '[label="("];\n', [] );
        nodoActual++;
        let parcPush = new NodoGraphviz("node_"+nodoActual , '[label=")"];\n', [] );
        nodoActual++;                        
        let ptrsPush = [idPush.id , $2.id, pushPush.id, paraPush.id, $6.id, parcPush.id];
        let resPush = new NodoGraphviz("node_"+nodoActual , '[label="Push"];\n', ptrsPush );
        nodoActual++;        
        listaNodos.push(idPush);
        listaNodos.push($2);        
        listaNodos.push(pushPush);
        listaNodos.push(paraPush);
        listaNodos.push($6);
        listaNodos.push(parcPush);
        $$ = resPush;        
    }
    |  'ID'  '.' 'PUSH' '(' Expr ')'
    {
        let idPush2 = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;        
        let pushPush2 = new NodoGraphviz("node_"+nodoActual , '[label="push"];\n', [] );
        nodoActual++;
        let paraPush2 = new NodoGraphviz("node_"+nodoActual , '[label="("];\n', [] );
        nodoActual++;
        let parcPush2 = new NodoGraphviz("node_"+nodoActual , '[label=")"];\n', [] );
        nodoActual++;                        
        let ptrsPush2 = [idPush.id , $2.id, pushPush.id, paraPush.id,  parcPush.id];
        let resPush2 = new NodoGraphviz("node_"+nodoActual , '[label="Push"];\n', ptrsPush2 );
        nodoActual++;        
        listaNodos.push(idPush2);
        listaNodos($2);        
        listaNodos.push(pushPush2);
        listaNodos.push(paraPush2);
        listaNodos.push(parcPush2);
        $$ = resPush2;
    }
;
...
Length
    : 'ID' accesos '.' 'LENGTH' 
    {
        let idLeng = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;        
        let lenLeng = new NodoGraphviz("node_"+nodoActual , '[label="length"];\n', [] );
        nodoActual++;        
        let resLeng = new NodoGraphviz("node_"+nodoActual , '[label="Length"];\n', [idLeng.id , $2.id, lenLeng.id] );
        nodoActual++;        
        listaNodos.push(idLeng);
        listaNodos($2);        
        listaNodos.push(lenLeng);
        listaNodos.push(resLeng);
        $$ = resLeng;

    }
    | 'ID'  '.' 'LENGTH'
    {
        let idLeng2 = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;        
        let lenLeng2 = new NodoGraphviz("node_"+nodoActual , '[label="length"];\n', [] );
        nodoActual++;        
        let resLeng2 = new NodoGraphviz("node_"+nodoActual , '[label="Length"];\n', [idLeng2.id , lenLeng2.id] );
        nodoActual++;        
        listaNodos.push(idLeng2);
        listaNodos.push(lenLeng2);
        listaNodos.push(resLeng2);
        $$ = resLeng2;        
    }
;
...
For
    ...
    { 
        let instrFor = new NodoGraphviz("node_"+nodoActual , '[label="for"];\n', [] );
        nodoActual++;
        let paraFor = new NodoGraphviz("node_"+nodoActual , '[label="("];\n', [] );
        nodoActual++;
        let parcFor = new NodoGraphviz("node_"+nodoActual , '[label=")"];\n', [] );
        nodoActual++;
        let  blockinstFor = new NodoGraphviz("node_"+nodoActual , '[label="BloqueInstrucciones"];\n', [$9.id]);
        nodoActual++;           
        let ptrsFor = [instrFor.id , paraFor.id , $3.id , $5.id , $7.id, parcFor.id, blockinstFor.id];
        let resFor = new NodoGraphviz("node_"+nodoActual , '[label="For"];\n', ptrsFor );
        nodoActual++;                                
        listaNodos.push(instrFor);
        listaNodos.push(paraFor);
        listaNodos.push($3);
        listaNodos.push($5);
        listaNodos.push($7);
        listaNodos.push(parcFor);
        listaNodos.push(blockinstFor);
        $$ = resFor;
    }    
;
...
IncrementoFor
    ...
    | 'ID' '++'
    {
        let idincFor = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;
        let incFor = new NodoGraphviz("node_"+nodoActual , '[label="++"];\n', [] );
        nodoActual++;        
        let resincFor = new NodoGraphviz("node_"+nodoActual , '[label="IncrementoFor"];\n', [idincFor.id, incFor.id] );
        nodoActual++; 
        listaNodos.push(idincFor );
        listaNodos.push(incFor);
        $$ = resincFor;       
    }
    | 'ID' '--'
    {
        let idincFor2 = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;
        let incFor2 = new NodoGraphviz("node_"+nodoActual , '[label="--"];\n', [] );
        nodoActual++;        
        let resincFor2 = new NodoGraphviz("node_"+nodoActual , '[label="IncrementoFor"];\n', [idincFor2.id, incFor2.id] );
        nodoActual++; 
        listaNodos.push(idincFor2);
        listaNodos.push(incFor2);
        $$ = resincFor2;
    }
;
...
DeclaracionFor
    : 'LET'   'ID' '=' Expr
    { 
        let dclFor = new NodoGraphviz("node_"+nodoActual , '[label="let"];\n', [] );
        nodoActual++;
        let idFor = new NodoGraphviz("node_"+nodoActual , '[label="'+$2+'"];\n', [] );
        nodoActual++;        
        let igdclFor = new NodoGraphviz("node_"+nodoActual , '[label="="];\n', [] );
        nodoActual++;
        let ptrsdclFor = [dclFor.id, idFor.id, igdclFor.id , $4.id];
        let resdclFor = new NodoGraphviz("node_"+nodoActual , '[label="DeclaracionFor"];\n', ptrsdclFor );
        nodoActual++;                
        listaNodos.push(dclFor);
        listaNodos.push(idFor);
        listaNodos.push(igdclFor);
        listaNodos.push($4);
        $$ = resdclFor;
    }
    | 'ID' '=' Expr 
    {
        let idFor2 = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;        
        let igdclFor2 = new NodoGraphviz("node_"+nodoActual , '[label="="];\n', [] );
        nodoActual++;
        let ptrsdclFor2 = [idFor2.id, igdclFor2.id , $3.id];
        let resdclFor2 = new NodoGraphviz("node_"+nodoActual , '[label="DeclaracionFor"];\n', ptrsdclFor2 );
        nodoActual++;                
        listaNodos.push(idFor2);
        listaNodos.push(igdclFor2);
        listaNodos.push($3);
        $$ = resdclFor2;
    }
;
...
ForIn
    ...
    {
        let instrForin = new NodoGraphviz("node_"+nodoActual , '[label="for"];\n', [] );
        nodoActual++;
        let paraForin = new NodoGraphviz("node_"+nodoActual , '[label="("];\n', [] );
        nodoActual++;
        let parcForin = new NodoGraphviz("node_"+nodoActual , '[label=")"];\n', [] );
        nodoActual++;
        let inForin = new NodoGraphviz("node_"+nodoActual , '[label="in"];\n', [] );
        nodoActual++;        
        let  blockinstForin = new NodoGraphviz("node_"+nodoActual , '[label="BloqueInstrucciones"];\n', [$7.id]);
        nodoActual++;           
        let ptrsForin = [instrForin.id , paraForin.id , $3.id , inForin.id , $5.id, parcForin.id, blockinstForin.id];
        let resForin = new NodoGraphviz("node_"+nodoActual , '[label="ForIn"];\n', ptrsForin );
        nodoActual++;                                
        listaNodos.push(instrForin);
        listaNodos.push(paraForin);
        listaNodos.push($3);
        listaNodos.push(inForin);
        listaNodos.push($5);
        listaNodos.push(parcForin);
        listaNodos.push(blockinstForin);
        $$ = resForin;
    }
;
...
ForOf
    ...
    {
        let instrForof = new NodoGraphviz("node_"+nodoActual , '[label="for"];\n', [] );
        nodoActual++;
        let paraForof = new NodoGraphviz("node_"+nodoActual , '[label="("];\n', [] );
        nodoActual++;
        let parcForof = new NodoGraphviz("node_"+nodoActual , '[label=")"];\n', [] );
        nodoActual++;
        let inForof = new NodoGraphviz("node_"+nodoActual , '[label="of"];\n', [] );
        nodoActual++;        
        let  blockinstForof = new NodoGraphviz("node_"+nodoActual , '[label="BloqueInstrucciones"];\n', [$7.id]);
        nodoActual++;           
        let ptrsForof = [instrForof.id , paraForof.id , $3.id , inForof.id , $5.id, parcForof.id, blockinstForof.id];
        let resForof = new NodoGraphviz("node_"+nodoActual , '[label="ForOf"];\n', ptrsForof );
        nodoActual++;                                
        listaNodos.push(instrForof);
        listaNodos.push(paraForof);
        listaNodos.push($3);
        listaNodos.push(inForof);
        listaNodos.push($5);
        listaNodos.push(parcForof);
        listaNodos.push(blockinstForof);
        $$ = resForof;
    }
;
...
declaracion_for
    : 'LET'   'ID' ':' tipo 
    {
        let dclForin = new NodoGraphviz("node_"+nodoActual , '[label="let"];\n', [] );
        nodoActual++;
        let idForin = new NodoGraphviz("node_"+nodoActual , '[label="'+$2+'"];\n', [] );
        nodoActual++;        
        let igdclForin = new NodoGraphviz("node_"+nodoActual , '[label=":"];\n', [] );
        nodoActual++;
        let tipoForin = new NodoGraphviz("node_"+nodoActual , '[label="tipo"];\n', [$4.id]);
        nodoActual++;        
        let ptrsdclForin = [dclForin.id, idForin.id, igdclForin.id , tipoForin.id];
        let resdclForin = new NodoGraphviz("node_"+nodoActual , '[label="DeclaracionFor"];\n', ptrsdclForin );
        nodoActual++;                
        listaNodos.push(dclForin);
        listaNodos.push(idForin);
        listaNodos.push(igdclForin);
        listaNodos.push(tipoForin);
        $$ = resdclForin;        
    }
    | 'LET'   'ID'
    {
        let dclForin2 = new NodoGraphviz("node_"+nodoActual , '[label="let"];\n', [] );
        nodoActual++;
        let idForin2 = new NodoGraphviz("node_"+nodoActual , '[label="'+$2+'"];\n', [] );
        nodoActual++;
        let ptrsdclForin2 = [dclForin2.id, idForin2.id];
        let resdclForin2 = new NodoGraphviz("node_"+nodoActual , '[label="DeclaracionFor"];\n', ptrsdclForin2 );
        nodoActual++;                        
        listaNodos.push(dclForin2);
        listaNodos.push(idForin2);
        $$ = resdclForin2;                
    }
    | 'CONST'   'ID' ':' tipo
    {
        let dclForin3 = new NodoGraphviz("node_"+nodoActual , '[label="const"];\n', [] );
        nodoActual++;
        let idForin3 = new NodoGraphviz("node_"+nodoActual , '[label="'+$2+'"];\n', [] );
        nodoActual++;        
        let igdclForin3 = new NodoGraphviz("node_"+nodoActual , '[label=":"];\n', [] );
        nodoActual++;
        let tipoForin3 = new NodoGraphviz("node_"+nodoActual , '[label="tipo"];\n', [$4.id]);
        nodoActual++;        
        let ptrsdclForin3 = [dclForin3.id, idForin3.id, igdclForin3.id , tipoForin3.id];
        let resdclForin3 = new NodoGraphviz("node_"+nodoActual , '[label="DeclaracionFor"];\n', ptrsdclForin3 );
        nodoActual++;                
        listaNodos.push(dclForin3);
        listaNodos.push(idForin3);
        listaNodos.push(igdclForin3);
        listaNodos.push(tipoForin3);
        $$ = resdclForin3;         
    }
    | 'CONST'   'ID'  
    {
        let dclForin4 = new NodoGraphviz("node_"+nodoActual , '[label="const"];\n', [] );
        nodoActual++;
        let idForin4 = new NodoGraphviz("node_"+nodoActual , '[label="'+$2+'"];\n', [] );
        nodoActual++;
        let ptrsdclForin4 = [dclForin4.id, idForin4.id];
        let resdclForin4 = new NodoGraphviz("node_"+nodoActual , '[label="DeclaracionFor"];\n', ptrsdclForin4);
        nodoActual++;                        
        listaNodos.push(dclForin4);
        listaNodos.push(idForin4);
        $$ = resdclForin4;         
    }
;
...
parametrosFuncion
    ...
    | 
    {
        let parameFunc = new NodoGraphviz("node_"+nodoActual , '[label="parametros"];\n', [] );
        nodoActual++;  
        $$ = parameFunc;           
    }
;
...
tipoFuncion
    ...
    | 
    {
        let tipoepFunc = new NodoGraphviz("node_"+nodoActual , '[label=" "];\n', [] );
        nodoActual++; 
        listaNodos.push(tipoepFunc); 
        $$ = tipoepFunc;        
    }
;
...
InstruccionesFun
    ...
    {
        let nodo_instruccionesAnid = new NodoGraphviz("node_"+nodoActual , '[label="Instrucciones"];\n', [$1.id]);
        nodoActual++;
        let nodo_instrAnid = new NodoGraphviz("node_"+nodoActual , '[label="Instruccion"];\n', [$2.id]);
        nodoActual++;
        let nodo_instrucciones2Anid = new NodoGraphviz("node_"+nodoActual , '[label="Instrucciones"];\n', [ nodo_instruccionesAnid.id, nodo_instrAnid.id ]);
        nodoActual++;

        listaNodos.push(nodo_instrucciones2Anid);        
        listaNodos.push(nodo_instruccionesAnid);
        listaNodos.push(nodo_instrAnid);
        $$ = nodo_instrucciones2Anid;
    } 
    | instrFun
    {        
        let nodo_declaracionAnid = new NodoGraphviz("node_"+nodoActual , '[label="Instruccion"];\n', [$1.id]);
        listaNodos.push(nodo_declaracionAnid);
        nodoActual++;
        $$ = nodo_declaracionAnid;
    }
;
...
instrFun
    ...
    | 'GRAFICAR' '(' ')' ';'
    {
        let paraGrafAn = new NodoGraphviz("node_"+nodoActual , '[label="("];\n', [] );
        nodoActual++;        
        let parcGrafAn = new NodoGraphviz("node_"+nodoActual , '[label=")"];\n', [] );
        nodoActual++;                
        let instGrafAn = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;
        let resGrafAn = new NodoGraphviz("node_"+nodoActual , '[label="GraficarTS"];\n', [instGrafAn.id ,paraGrafAn.id, parcGrafAn.id] );
        nodoActual++;                
        listaNodos.push(resGrafAn);
        listaNodos.push(instGrafAn);        
        listaNodos.push(paraGrafAn);
        listaNodos.push(parcGrafAn);
        $$ = resGrafAn;        
    }
    | 'BREAK' ';'
    {
        let instBreakAn = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;
        listaNodos.push(instBreakAn);
        $$ = instBreakAn; 
    }
    | 'CONTINUE' ';'
    {
        let instContAn = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;
        listaNodos.push(instContAn);
        $$ = instContAn;        
    }
    | 'RETURN' ternario ';'
    {
        let instRet3An = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;
        let resReturn3An = new NodoGraphviz("node_"+nodoActual , '[label="Return"];\n', [instRet3An.id , $2.id]);
        nodoActual++;                
        listaNodos.push(instRet3An);
        listaNodos.push($2);
        listaNodos.push(resReturn3An);
        $$ = resReturn3An;           
    }
    | 'RETURN' Expr ';'
    {
        let instRet2An = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;
        let resReturnAn = new NodoGraphviz("node_"+nodoActual , '[label="Return"];\n', [instRet2An.id , $2.id]);
        nodoActual++;                
        listaNodos.push(instRet2An);
        listaNodos.push($2);
        listaNodos.push(resReturnAn);
        $$ = resReturnAn;   
    }
    | 'RETURN' ';'
    {
        let instRetAn = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;
        listaNodos.push(instRetAn);
        $$ = instRetAn;        
    }
    | 'ID' '++' ';'
    {
        let idIncAn = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;            
        let masmasIncAn = new NodoGraphviz("node_"+nodoActual , '[label="++"];\n', [] );
        nodoActual++;        
        let resIncMasAn = new NodoGraphviz("node_"+nodoActual , '[label="Incremento"];\n', [idIncAn.id,masmasIncAn.id] );
        nodoActual++;        
        listaNodos.push(resIncMasAn);        
        listaNodos.push(idIncAn);
        listaNodos.push(masmasIncAn);
        $$ = resIncMasAn;        
    }
    | 'ID' '--' ';'
    {
        let idDecrAn = new NodoGraphviz("node_"+nodoActual , '[label="'+$1+'"];\n', [] );
        nodoActual++;            
        let menmenIncAn = new NodoGraphviz("node_"+nodoActual , '[label="--"];\n', [] );
        nodoActual++;        
        let resDecMenAn = new NodoGraphviz("node_"+nodoActual , '[label="Decremento"];\n', [idDecrAn.id,menmenIncAn.id] );
        nodoActual++;        
        listaNodos.push(resDecMenAn);        
        listaNodos.push(idDecrAn);
        listaNodos.push(menmenIncAn);
        $$ = resDecMenAn;
    } 
;
...
funcionFun
    ...
    {
        //Nodo Function
        let instFunctionAn = new NodoGraphviz("node_"+nodoActual , '[label="function"];\n', [] );
        nodoActual++;       
        //Nodo Function
        let instIdFnAn = new NodoGraphviz("node_"+nodoActual , '[label="'+$2+'"];\n', [] );
        nodoActual++;                 
        //Nodo Function
        let paraFnAn = new NodoGraphviz("node_"+nodoActual , '[label="("];\n', [] );
        nodoActual++;                         
        let parcFnAn = new NodoGraphviz("node_"+nodoActual , '[label=")"];\n', [] );
        nodoActual++;
        let dsptsFnAn = new NodoGraphviz("node_"+nodoActual , '[label=":"];\n', [] );
        nodoActual++;        
        let tipoFnAn = new NodoGraphviz("node_"+nodoActual , '[label="tipo"];\n', [$6.id] );
        nodoActual++;

        let llaveaFnAn = new NodoGraphviz("node_"+nodoActual , '[label="{"];\n', [] );
        nodoActual++;                         
        let llavecFnAn = new NodoGraphviz("node_"+nodoActual , '[label="}"];\n', [] );
        nodoActual++;        

        let bloqueFnAn = new NodoGraphviz("node_"+nodoActual , '[label="BloqueInstrucciones"];\n', [$8.id] );
        nodoActual++;        

        let resFnAn = new NodoGraphviz("node_"+nodoActual , '[label="Funcion"];\n', [instFunctionAn.id, instIdFnAn.id, paraFnAn.id, $4.id, parcFnAn.id, dsptsFnAn.id , tipoFnAn.id, llaveaFnAn.id, bloqueFnAn.id, llavecFnAn.id] );
        nodoActual++;     

        listaNodos.push(instFunctionAn);
        listaNodos.push(instIdFnAn);
        listaNodos.push(paraFnAn);
        listaNodos.push($4);
        listaNodos.push(parcFnAn);
        listaNodos.push(dsptsFnAn);
        listaNodos.push(tipoFnAn);
        listaNodos.push(llaveaFnAn);
        listaNodos.push(bloqueFnAn);
        listaNodos.push(llavecFnAn);
        $$ = resFnAn;   
    } 
;
idFunAnid
...
F   : '(' Expr ')'
    ...
    | 'CADENA'
    {
        let fCadena = new NodoGraphviz("node_"+nodoActual , '[label="'+$1.replace(/\"/g,"")+'"];\n', [] );
    ...
    | 'CADENASIM'
    {
        let fCadenaSim = new NodoGraphviz("node_"+nodoActual , '[label="'+$1.replace(/\"/g,"")+'"];\n', [] );
